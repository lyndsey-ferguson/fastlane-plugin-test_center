...
|_reuse_simulators_for_parallel_testruns_<br/>♥️ Coming Dec 18th, 2020|Find simulators (or clone new ones) that match the requested device for the parallel test runs. This option sets :pre_delete_cloned_simulators to false|false|
